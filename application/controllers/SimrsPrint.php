...
class SimrsPrint extends CI_Controller {
    ...
    function printEX($id_detail)
    {
        ...
        $pdf->Image(base_url('/assets/img/logo_rs.png'), 175, 10, 25, 20);
        ...
        $y = $pdf->GetY();
        $pdf->SetXY(10,$y+1);
        $pdf->MultiCell(50,4,'Diagnostik Klinik');
        // $pdf->Cell(10,7,'Dokter Pengirim',0,1);
        ...
        $pdf->SetXY(45, $y+1);
        $pdf->MultiCell(56,4,$isi ['diagnostik_klinik']);

        $pdf->SetXY(110,$y+1);
        $pdf->MultiCell(35,3,'Diagnostik Pasca Bedah');
        // $pdf->Cell(10,7,'Dokter Pengirim',0,1);
        ...
        $pdf->SetXY(150, $y+1);
        $pdf->MultiCell(56,4,$isi['diagnostik_pasca_bedah']);


        $y = $pdf->GetY();
        // $pdf->Cell(10,7,$isi['tgl_baca'],0,1);
        $pdf->Line(10, $y+3, 205,$y+3);
        $pdf->Line(10, $y+4, 205,$y+4);
